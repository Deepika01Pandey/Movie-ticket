                      ...
                      <div className="p-2">
                        ...
                        <div className="flex max-sm:flex-col justify-between items-center">
                          ...
                          <button
                            ...
                            className="bg-black font-bold max-sm:mt-1 text-white px-3 py-2 max-sm:text-xs max-sm:px-2 max-sm:py-1 max-sm:text-normal text-sm text-medium rounded-lg hover:bg-red-600"
                          >
                            Book Now
                          </button>
                        </div>
